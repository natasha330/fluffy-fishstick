      ...
      <header className="md:hidden sticky top-0 z-50 border-b bg-background">
        <div className="flex items-center justify-between p-4">
          <Link to="/" className="flex items-center gap-2">
            ...
            <span className="font-bold">Buyer Center</span>
          </Link>
          ...
          <div className="flex flex-col h-full">
            ...
            <div className="hidden md:flex items-center gap-2 p-6 border-b">
              <Link to="/" className="flex items-center gap-2">
                ...
                <span className="text-xl font-bold">Buyer Center</span>
              </Link>
            </div>
            ...
            <div className="p-4 border-b">
              <div className="flex items-center gap-3">
                ...
                <div className="min-w-0">
                  <p className="font-medium truncate">{profile?.full_name || 'Buyer'}</p>
            ...
            <nav className="flex-1 p-4 space-y-1">
              {navItems.map((item) => {
                const isActive = location.pathname === item.href || 
                  (item.href !== '/buyer' && location.pathname.startsWith(item.href));
